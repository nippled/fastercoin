...
uint256 hashGenesisBlock("0x19d117a1eb99ae5346d12a2a35a59c88f8d1b8e501a9d6216d89005c53f223cc");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(521093680); // FasterCoin: starting difficulty is 1 / 2^48
...
const string strMessageMagic = "FasterCoin Signed Message:\n";
...
{
    // FasterCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 3200000000;
    if (nHeight == 1) return 110000000000000;

    // Subsidy is cut in half every year
    nSubsidy >>= (nHeight / 1290000); // FasterCoin: Billions of orphans in a year

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 110; // FasterCoin: 110 seconds
static const int64 nTargetSpacing = 11; // 10 blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // FasterCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // FasterCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // FasterCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x7700be142698ded3dce803bdf09f0d9ffb549feb548b2ab3fd55e506bc0eb958");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Orphan and Widow Maker. Maker of Chains of many";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 3200000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("d19591da0701390b36483988399ab11364c38a0fb6eea5c56f42a2f6d30672c67547c3e2268f2bb29ac13e0921acf49b28b64d1e347e38f29af3da8c03e8e38844") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1452078904;
        block.nBits    = 521093680;
        block.nNonce   = 1758107410;

        if (fTestNet)
        {
            block.nTime    = 1452078904;
            block.nNonce   = 1517313208;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf3b05d1b670d776408a94f2641c07e376e9fff6af98fba95cf5423275cd041b8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // FasterCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FasterCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FasterCoinMiner : ProcessBlock, block not accepted");
    }
